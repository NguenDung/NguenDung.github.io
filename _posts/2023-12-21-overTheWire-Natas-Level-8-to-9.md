...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-9-to-10/' | relative_url }}">Next: Level 9 → 10 →</a>
  </div>
</nav>

## Login

Use the **natas8** account from the previous level.

```bash
ssh natas8@natas.labs.overthewire.org -p <PORT>
