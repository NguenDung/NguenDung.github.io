...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-20-to-21/' | relative_url }}">Next: Level 20 → 21 →</a>
  </div>
</nav>

## Login

Use the **natas19** account from the previous level.

```bash
ssh natas19@natas.labs.overthewire.org -p <PORT>
