...
title: "OverTheWire Natas Level 31 → 32 tutorial!!"
permalink: /posts/overTheWire-Natas-Level-31-to-32/
tags: [overthewire, natas, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Natas Level 31 → 32!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Natas-Level-30-to-31/' | relative_url }}">← Previous: Level 30 → 31</a>
  </div>
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-32-to-33/' | relative_url }}">Next: Level 32 → 33 →</a>
  </div>
</nav>

## Login

Use the **natas31** account from the previous level.

```bash
ssh natas31@natas.labs.overthewire.org -p <PORT>
