...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-23-to-24/' | relative_url }}">Next: Level 23 → 24 →</a>
  </div>
</nav>

## Login

Use the **natas22** account from the previous level.

```bash
ssh natas22@natas.labs.overthewire.org -p <PORT>
