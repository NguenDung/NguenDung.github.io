...
title: "OverTheWire Natas Level 26 → 27 tutorial!!"
permalink: /posts/overTheWire-Natas-Level-26-to-27/
tags: [overthewire, natas, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Natas Level 26 → 27!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Natas-Level-25-to-26/' | relative_url }}">← Previous: Level 25 → 26</a>
  </div>
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-27-to-28/' | relative_url }}">Next: Level 27 → 28 →</a>
  </div>
</nav>

## Login

Use the **natas26** account from the previous level.

```bash
ssh natas26@natas.labs.overthewire.org -p <PORT>
