---
date: 2023-10-12 00:00:00 +0700
layout: post-with-comments
title: "OverTheWire Manpage Level 6 → 7 tutorial!!"
permalink: /posts/overTheWire-Manpage-Level-6-to-7/
tags: [overthewire, manpage, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Manpage Level 6 → 7!!"
---
...
<nav class="manpage-nav" aria-label="Manpage level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Manpage-Level-5-to-6/' | relative_url }}">← Previous: Level 5 → 6</a>
  </div>
...
Use the **manpage6** account from the previous level.

```bash
ssh manpage6@manpage.labs.overthewire.org -p <PORT>
