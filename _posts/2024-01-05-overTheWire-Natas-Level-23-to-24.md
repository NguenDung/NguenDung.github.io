...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-24-to-25/' | relative_url }}">Next: Level 24 → 25 →</a>
  </div>
</nav>

## Login

Use the **natas23** account from the previous level.

```bash
ssh natas23@natas.labs.overthewire.org -p <PORT>
