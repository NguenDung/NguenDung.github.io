...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-8-to-9/' | relative_url }}">Next: Level 8 → 9 →</a>
  </div>
</nav>

## Login

Use the **natas7** account from the previous level.

```bash
ssh natas7@natas.labs.overthewire.org -p <PORT>
