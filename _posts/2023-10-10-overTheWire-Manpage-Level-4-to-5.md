...
title: "OverTheWire Manpage Level 4 → 5 tutorial!!"
permalink: /posts/overTheWire-Manpage-Level-4-to-5/
tags: [overthewire, manpage, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Manpage Level 4 → 5!!"
---
...
<nav class="manpage-nav" aria-label="Manpage level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Manpage-Level-3-to-4/' | relative_url }}">← Previous: Level 3 → 4</a>
  </div>

  <div class="nav-center">
    <a href="https://overthewire.org/wargames/" target="_blank" rel="noopener">Official Manpage ↗</a>
  </div>

  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Manpage-Level-5-to-6/' | relative_url }}">Next: Level 5 → 6 →</a>
  </div>
</nav>

## Login

Use the **manpage4** account from the previous level.

```bash
ssh manpage4@manpage.labs.overthewire.org -p <PORT>
