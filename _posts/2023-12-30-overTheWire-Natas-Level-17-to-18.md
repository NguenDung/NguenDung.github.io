...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-18-to-19/' | relative_url }}">Next: Level 18 → 19 →</a>
  </div>
</nav>

## Login

Use the **natas17** account from the previous level.

```bash
ssh natas17@natas.labs.overthewire.org -p <PORT>
