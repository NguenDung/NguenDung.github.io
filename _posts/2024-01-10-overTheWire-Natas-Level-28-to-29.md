...
title: "OverTheWire Natas Level 28 → 29 tutorial!!"
permalink: /posts/overTheWire-Natas-Level-28-to-29/
tags: [overthewire, natas, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Natas Level 28 → 29!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Natas-Level-27-to-28/' | relative_url }}">← Previous: Level 27 → 28</a>
  </div>
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-29-to-30/' | relative_url }}">Next: Level 29 → 30 →</a>
  </div>
</nav>

## Login

Use the **natas28** account from the previous level.

```bash
ssh natas28@natas.labs.overthewire.org -p <PORT>
