...
description: "A step by step tutorial for OverTheWire Natas Level 25 → 26!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-26-to-27/' | relative_url }}">Next: Level 26 → 27 →</a>
  </div>
</nav>

## Login

Use the **natas25** account from the previous level.

```bash
ssh natas25@natas.labs.overthewire.org -p <PORT>
