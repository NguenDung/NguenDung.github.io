...
title: "OverTheWire Natas Level 29 → 30 tutorial!!"
permalink: /posts/overTheWire-Natas-Level-29-to-30/
tags: [overthewire, natas, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Natas Level 29 → 30!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Natas-Level-28-to-29/' | relative_url }}">← Previous: Level 28 → 29</a>
  </div>
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-30-to-31/' | relative_url }}">Next: Level 30 → 31 →</a>
  </div>
</nav>

## Login

Use the **natas29** account from the previous level.

```bash
ssh natas29@natas.labs.overthewire.org -p <PORT>
