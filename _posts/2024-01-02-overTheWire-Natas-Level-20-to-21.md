...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-21-to-22/' | relative_url }}">Next: Level 21 → 22 →</a>
  </div>
</nav>

## Login

Use the **natas20** account from the previous level.

```bash
ssh natas20@natas.labs.overthewire.org -p <PORT>
