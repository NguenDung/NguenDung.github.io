...
title: "OverTheWire Natas Level 30 → 31 tutorial!!"
permalink: /posts/overTheWire-Natas-Level-30-to-31/
tags: [overthewire, natas, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Natas Level 30 → 31!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Natas-Level-29-to-30/' | relative_url }}">← Previous: Level 29 → 30</a>
  </div>
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-31-to-32/' | relative_url }}">Next: Level 31 → 32 →</a>
  </div>
</nav>

## Login

Use the **natas30** account from the previous level.

```bash
ssh natas30@natas.labs.overthewire.org -p <PORT>
