...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-3-to-4/' | relative_url }}">Next: Level 3 → 4 →</a>
  </div>
</nav>

## Login

Use the **natas2** account from the previous level.

```bash
ssh natas2@natas.labs.overthewire.org -p <PORT>
