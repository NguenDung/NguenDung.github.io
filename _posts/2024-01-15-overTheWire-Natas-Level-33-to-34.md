...
title: "OverTheWire Natas Level 33 → 34 tutorial!!"
permalink: /posts/overTheWire-Natas-Level-33-to-34/
tags: [overthewire, natas, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Natas Level 33 → 34!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Natas-Level-32-to-33/' | relative_url }}">← Previous: Level 32 → 33</a>
  </div>
...
Use the **natas33** account from the previous level.

```bash
ssh natas33@natas.labs.overthewire.org -p <PORT>
