...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-1-to-2/' | relative_url }}">Next: Level 1 → 2 →</a>
  </div>
</nav>

## Login

Use the **natas0** account from the previous level.

```bash
ssh natas0@natas.labs.overthewire.org -p <PORT>
