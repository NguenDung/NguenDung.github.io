...
title: "OverTheWire Natas Level 32 → 33 tutorial!!"
permalink: /posts/overTheWire-Natas-Level-32-to-33/
tags: [overthewire, natas, walkthrough, ctf, linux]
description: "A step by step tutorial for OverTheWire Natas Level 32 → 33!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  <div class="nav-left">
    <a href="{{ '/posts/overTheWire-Natas-Level-31-to-32/' | relative_url }}">← Previous: Level 31 → 32</a>
  </div>
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-33-to-34/' | relative_url }}">Next: Level 33 → 34 →</a>
  </div>
</nav>

## Login

Use the **natas32** account from the previous level.

```bash
ssh natas32@natas.labs.overthewire.org -p <PORT>
