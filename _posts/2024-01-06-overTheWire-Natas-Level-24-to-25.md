...
description: "A step by step tutorial for OverTheWire Natas Level 24 → 25!!"
---
...
<nav class="natas-nav" aria-label="Natas level navigation">
  ...
  <div class="nav-right">
    <a href="{{ '/posts/overTheWire-Natas-Level-25-to-26/' | relative_url }}">Next: Level 25 → 26 →</a>
  </div>
</nav>

## Login

Use the **natas24** account from the previous level.

```bash
ssh natas24@natas.labs.overthewire.org -p <PORT>
